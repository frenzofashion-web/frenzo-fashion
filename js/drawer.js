...
class FrenzoDrawer {
  ...
  _renderContent(look) {
    ...
    this.lookSeason.textContent = look.season.charAt(0).toUpperCase() + look.season.slice(1);
  ...
  _createProductItem(product, idx) {
    ...
    li.innerHTML = `
      <a 
        ...
        aria-label="${indexStr}. ${product.label} - ${product.name}"
      ...
      >
        ...
        <div class="product__info">
          ...
          <div class="product__tagline">${product.tagline || ''}</div>
        </div>
